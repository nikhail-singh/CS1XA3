...
-- | this function performs the parsing of doubles format is:
-- | symbols
--    * addition        -> +
--
--    * subtraction     -> -
...
--    * e^x             -> exp
--
--    * constant       -> just  write the value ie 5
--
...
-- | this function performs the parsing of strings
...
-- | this function performs the parsing of floats format is:
-- | symbols
--    * addition        -> +
--
--    * subtraction     -> -
